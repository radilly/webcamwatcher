#!/usr/bin/python
#
#   What conditions should trigger a webcam power-cycle?
#
#   * On the system collecting images we have NOT seen a recent update.
#
#   * We get a damaged image file.  Could be too small.
#       * Probably need several in a row before power-cycle.
#
#   * If the image on the web server hasn't been updated recently.
#       * There is a propogation delay.  Server code polls periodically.
#       * We can lose access to the web-server, which should not cause a power-cycle.
#
#
#   NOTE: Don't power-cycle the webcam to frequently.  Takes 10 or 15 secs to reboot.
#
# ========================================================================================
# 20181028 RAD Pulling together code which triggers a reboot.
#              WARNING 
# ========================================================================================
...
#
#  * If the size of the image is too small, power-cycle the camera.
#
#
# ----------------------------------------------------------------------------------------
def next_image_file() :
