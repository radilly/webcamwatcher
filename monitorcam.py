...
#	check_counter += 1
	...
	# ================================================================================
# @@@@@@
#DEBUG#	log_and_message( 'DEBUG: time.time() = {}'.format( time.time() ) )
#DEBUG#	log_and_message( 'DEBUG: int( time.time() ) = {}'.format( int( time.time() ) ) )
#DEBUG#	log_and_message( 'DEBUG: datetime.datetime.now().strftime() = {}'.format( datetime.datetime.now().strftime( "%s" ) ) )

	calculated = int( time.time() ) - age_secs
